...
public class Main_LoginAndRegister extends javax.swing.JFrame {
    ...
    private final DecimalFormat df = new DecimalFormat("##0.###", new java.text.DecimalFormatSymbols(java.util.Locale.US));
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_LoginAndRegister.class.getName())
